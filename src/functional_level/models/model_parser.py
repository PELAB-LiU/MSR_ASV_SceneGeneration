...
class ModelParser:
    ...
    TOTAL_REL_FECS = {(2, 0): 7, (3, 0): 28, (4, 0): 84, (5, 0): 210, (6, 0): 462}

    TOTAL_AMB_FECS = {(2, 0): 0, (3, 0): 12, (4, 0): 54, (5, 0): 160, (6, 0): 385}
    ...
    def parse_problem(problem: str) -> FunctionalScenario:
        ...
        relationship_patterns = {
            ...
            "overtakingToStarboard": lambda o1, o2: builder.add_overtaking_to_starboard(
                o1, o2
            ),
            "crossingFromPort": lambda o1, o2: builder.add_crossing_from_port(o1, o2),
            "atDangerousHeadOnSectorOf": lambda o1, o2: builder.add_at_dangerous_head_on_sector_of(
                o1, o2
            ),
            "vesselType": lambda o1, o2: builder.add_vessel_type(o1, o2),
            "staticObstacleType": lambda o1, o2: builder.static_obstacle_type_interpretation.add(
                o1, o2
            ),
            "inSternSectorOf": lambda o1, o2: builder.in_stern_sector_of_interpretation.add(
                o1, o2
            ),
            "inPortSideSectorOf": lambda o1, o2: builder.in_port_side_sector_of_interpretation.add(
                o1, o2
            ),
            "inStarboardSideSectorOf": lambda o1, o2: builder.in_starboard_side_sector_of_interpretation.add(
                o1, o2
            ),
            "inBowOnSectorOf": lambda o1, o2: builder.in_bow_sector_of_interpretation.add(
                o1, o2
            ),
            "atVisibilityDistance": lambda o1, o2: builder.at_visibility_distance_interpretation.add(
                o1, o2
            ),
            "outVisibilityDistance": lambda o1, o2: builder.out_visibility_distance_interpretation.add(
                o1, o2
            ),
            "inVisibilityDistance": lambda o1, o2: builder.in_visibility_distance_interpretation.add(
                o1, o2
            ),
    ...
    def __load_functional_scenarios(dir: str) -> List[FunctionalScenario]:
        return [
            ModelParser.parse_problem(ModelParser.load_problem_from_file(path))
            for path in get_all_file_paths(dir, ["problem"])["problem"]
        ]

    @staticmethod
    def load_functional_scenarios(
        vessel_number: int, obstacle_number: int
    ) -> List[FunctionalScenario]:
        scenarios = ModelParser.__load_functional_scenarios(
            ModelParser.scenario_path_map[(vessel_number, obstacle_number)]
        )
        if (
            len(scenarios)
            != ModelParser.TOTAL_REL_FECS[(vessel_number, obstacle_number)]
        ):
            raise ValueError(
                f"Expected {ModelParser.TOTAL_REL_FECS[(vessel_number, obstacle_number)]} scenarios, but found {len(scenarios)} in {ModelParser.scenario_path_map[(vessel_number, obstacle_number)]}"
            )
        return scenarios

    @staticmethod
    def load_ambiguous_functional_scenarios(
        vessel_number: int, obstacle_number: int
    ) -> List[FunctionalScenario]:
        return ModelParser.__load_functional_scenarios(
            ModelParser.ambiguous_scenario_path_map[(vessel_number, obstacle_number)]
        )
