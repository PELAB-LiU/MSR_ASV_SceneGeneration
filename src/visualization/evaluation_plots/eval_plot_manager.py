...
class EvalPlotManager:
    def __init__(self, eval_datas: List[EvaluationData]):
        ...
        self.plots: Dict[str, PlotWrapper] = {
            ".---------------------------------------.": PlotWrapper(
                DummyEvalPlot, {"eval_datas": self.eval_datas}
            ),
            ...
            "Relevant Coverage Evolution": PlotWrapper(
                RelevantCoverageEvolutionPlot, {"eval_datas": self.eval_datas}
            ),
            "Relevant Coverage": PlotWrapper(
                RelevantCoveragePlot, {"eval_datas": self.eval_datas}
            ),
            "Time to 100% Coverage": PlotWrapper(
                RelevantTimeToFullCoveragePlot, {"eval_datas": self.eval_datas}
            ),
            ...
            "Time Per Eqv Class": PlotWrapper(
                TimePerEqvClassPlot,
                {"eval_datas": self.eval_datas, "is_all": True, "is_algo": False},
            ),
            "Time Per Eqv Class For Valid Scenes": PlotWrapper(
                TimePerEqvClassForValidPlot,
                {"eval_datas": self.eval_datas, "is_all": True, "is_algo": False},
            ),
            "Time Per Scene": PlotWrapper(
                TimePerScenePlot,
                {"eval_datas": self.eval_datas, "is_all": True, "is_algo": False},
            ),
            ...
            "Rare Scenario Plot": PlotWrapper(
                RareScenarioPlot, {"eval_datas": self.eval_datas}
            ),
        }
        ...
        self.canvas = FigureCanvasTkAgg(
            list(self.plots.values())[0].get().fig, master=self.plot_frame
        )
