...
class FunctionalModelManager:
    ...
    @classmethod
    def get_x_vessel_y_obstacle_ambiguous_scenarios(
        ...
        if cls.__ambiguous_scenario_cache_map[actor_number_by_type] is None:
            cls.__ambiguous_scenario_cache_map[actor_number_by_type] = (
                ModelParser.load_ambiguous_functional_scenarios(
    ...
    def get_x_vessel_y_obstacle_scenarios(
        ...
        if cls.__scenario_cache_map[actor_number_by_type] is None:
            cls.__scenario_cache_map[actor_number_by_type] = (
                ModelParser.load_functional_scenarios(vessel_number, obstacle_number)
            )
